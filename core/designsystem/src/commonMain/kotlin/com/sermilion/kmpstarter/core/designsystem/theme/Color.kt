...
object PlanApprovalColors {
  val ApprovalApprovedColor = Color(0xFFECF4D1)
  val ApprovalApprovedWithCommentsColor = Color(0xFFFFE8CC)
  val ApprovalPendingColor = Color(0xFFFFF0A5)
  val ApprovalRejectedColor = Color(0xFFFFC7C7)
  val ApprovalCancelledColor = Grey100
}

object AiAssistantColors {
  val HaloColor1 = Color(0x33E4F987)
  val HaloColor2 = Color(0x33BBE986)

  val ButtonColor1 = Color(0xFFE6F6AA)
  val ButtonColor2 = Color(0xFF8BFDFD)
  val ButtonOverlay1 = Color(0x66E4F987)
  val ButtonOverlay2 = Color(0x66BBE986)
  val ButtonShine = Color(0x33A2C617)
  val ButtonDisabled = Color(0x80FFFFFF)

  val ButtonIconDisabled = Color(0xFF8FD78D)
  val ButtonIconEnabled: Color
    @Composable get() = KmpTheme.colors.onSurface.copy(alpha = KmpContentAlpha.mediumEmphasis)

  val WarningColor = Color(0xFFFDE66E)
  ...
  val ButtonBackgroundGradient: Brush
    ...
    get() {
      val gradient =
        Brush.composite(
          dstBrush = Brush.horizontalGradient(listOf(ButtonColor1, ButtonColor2)),
          srcBrush = Brush.verticalGradient(listOf(ButtonOverlay1, ButtonOverlay2)),
          blendMode = BlendMode.Color,
        )
      return Brush.composite(
        dstBrush = gradient,
        srcBrush = SolidColor(ButtonShine),
        blendMode = BlendMode.Color,
      )
    }

  val ButtonBackgroundAlternate: Brush
    @Composable get() = SolidColor(KmpTheme.colors.inverseOnSurface)

  val ButtonBackgroundDisabled: Brush
    @Composable get() = SolidColor(KmpTheme.colors.inverseOnSurface.copy(alpha = 0.2f))
}

object RichTextColors {
  val RoyalBlue = Color(0xFF1C6EF2)
  val Vermilion = Color(0xFFE22518)
  val Amber = Color(0xFFFABD05)
  val MediumGray = Color(0xFF969696)
